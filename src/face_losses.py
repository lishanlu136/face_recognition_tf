#!/usr/bin/env python
# -*- coding: utf-8 -*-
# @Time       : 2018/10/8 14:07
# @Author     : Li Shanlu
# @File       : face_losses.py
# @Software   : PyCharm
# @Description: Loss function, contains arcface_loss, cosineface_loss and combine_loss
...
def arcface_loss(embedding, labels, out_num, w_init=None, s=64., m=0.5):
    ...
    with tf.variable_scope('arcface_loss'):
        ...
        cos_mt = s * tf.subtract(tf.multiply(cos_t, cos_m), tf.multiply(sin_t, sin_m), name='cos_mt')  # cos(mt)=cos(m)cos(t)-sin(m)sin(t)
